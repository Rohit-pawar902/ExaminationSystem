<%-- 
    ...
    Created on : 16 Apr, 2021, 3:01:28 PM
    Author     : DELL
--%>
            ...
            <div id="jadoun">
                <center>
                    <table cellpadding="12px">
                        <tr>
                            <th class="jkm text-center" colspan="2">Student Registration</th>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input type="email" placeholder="Enter Email" class="j" onkeyup="mail2()" id="E1" name="uemail" required><br>
                                <span id="E2">  </span></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td class="jk">EducationField<span class="text-muted">(Cs/Mech)</span></td>
                            <td><input type="text" placeholder="Enter EduField" class="j" name="eduField" required><br>
                                <span id="DOB2">  </span></td>
                        </tr>
                        <tr>
                            <td class="jk">Mobile Number</td>
                            <td><input type="tel" placeholder="Enter Contact" class="j" onkeyup="contact2()"  name="umob" required><br>
                                <span id="CN2">  </span></td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div class="form-check">
                                    <input type="checkbox" name="check" value="1" class="j" id="exampleCheck1">
                                </div>
                            </td>
                        </tr>
                        <tr>	
