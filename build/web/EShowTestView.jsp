...
<%
    int id = Integer.parseInt(request.getParameter("tid"));//MockTest id examinee
    String s = request.getParameter("ttitle"); //TestName
%>
            ...
            <div class="container text-center">
                ...
                <table class="text-primary table table-hover table-striping ">
                    ...
                    %>
                        ...
                        <tr>
                            <th colspan="4"><span class="mr-1"><span>Q-<%=i%>)</span><%=m1.getQue()%><button type="button" class="close" onclick="deleteQue(<%=m1.getId()%>,this)"  aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button></span></th>
                        </tr>
                        <tr>
