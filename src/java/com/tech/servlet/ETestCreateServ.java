 ...
 */
@MultipartConfig
public class ETestCreateServ extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            m.setCatid(Integer.parseInt(request.getParameter("catid")));
            m.setEid(Integer.parseInt(request.getParameter("eid")));
            m.setName(request.getParameter("Ttitle"));
            m.setPassword(request.getParameter("Tpass"));
            m.setDescription(request.getParameter("Tdesc"));
