 ...
 */
@MultipartConfig
public class StuExamineeSubmitServ extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String ePassword=request.getParameter("Epass");
            
            ExamineeExaminationDAO e=new ExamineeExaminationDAO(ConnectionProvider.getConnection());
            int  eid= e.authenticateStuToExamineeTest(eName,ePassword);
            if(eid != -1){
                out.print(eid);
            }
            else{
